...
```sh
> cargo run --bin burnbench -- run --benches unary binary --backends wgpu-fusion libtorch-gpu
...
- Benchmark: unary, Backend: libtorch-gpu
- Benchmark: binary, Backend: libtorch-gpu
Running benchmarks...
```
